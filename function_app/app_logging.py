...
class StructuredLogger:
    ...
    def info(self, event: str, data: dict[str, Any] | None = None):
        """Log INFO level message."""
        self._log("INFO", event, data or {})

    def warning(self, event: str, data: dict[str, Any] | None = None):
        """Log WARNING level message."""
        self._log("WARNING", event, data or {})

    def error(self, event: str, data: dict[str, Any] | None = None):
        """Log ERROR level message."""
        self._log("ERROR", event, data or {})

    def debug(self, event: str, data: dict[str, Any] | None = None):
